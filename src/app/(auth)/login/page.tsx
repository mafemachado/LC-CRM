    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-brand-gradient flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white mb-12">
          ...
          <h1 className="font-heading text-5xl text-white mb-2">
            LIÇÃO DE CASA
          </h1>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="font-sub text-2xl font-bold text-foreground">
              Bem-vindo de volta!
            </h2>
          ...
          <form className="space-y-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="font-sub font-medium">
                E-mail
              </Label>
              <Input
                id="email"
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <Label htmlFor="password" className="font-sub font-medium">
                  Senha
                </Label>
                <Link
                  href="/esqueci-senha"
            ...
            <Button
              type="submit"
              className="w-full h-11 font-sub font-semibold text-base rounded-lg"
            >
              Entrar
            </Button>
          </form>
          ...
          <p className="text-center text-sm text-muted-foreground mt-8">
            ...
            <a
              href="mailto:suporte@licaodecasa.com.br"
